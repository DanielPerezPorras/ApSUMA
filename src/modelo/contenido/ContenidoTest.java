...
import gui.contenido.VistaContenidoEnlace;
import gui.contenido.VistaContenidoTest;
import modelo.BD;
import modelo.ErrorBD;
import modelo.Evento;

public class ContenidoTest extends Contenido {

    private String enlace;
    private String textoVisible;

    public ContenidoTest(Evento ev, String enlace, String textoVisible)
    {
        super(ev);
        BD bd = new BD();
    ...
    @Override
    public String getTipo() { return "prueba"; }

    @Override
    public VistaContenido getVista(boolean modoEdicion) {
        return new VistaContenidoTest(this, modoEdicion);
    }
