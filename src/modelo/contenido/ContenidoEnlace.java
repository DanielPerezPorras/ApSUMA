...
public class ContenidoEnlace extends Contenido {
    ...
    public ContenidoEnlace(Evento ev, String enlace, String textoVisible) {
        super(ev);
        BD bd = new BD();
    ...
    @Override
    public String getTipo() { return "link"; }

    @Override
    public VistaContenido getVista(boolean modoEdicion) {
        return new VistaContenidoEnlace(this, modoEdicion);
    }
