...
import gui.contenido.VistaContenidoLlamada;
import modelo.BD;
import modelo.ErrorBD;
import modelo.Evento;

public class ContenidoLlamada extends Contenido {

    private String enlace;
    private String textoVisible;

    public ContenidoLlamada(Evento ev, String enlace, String textoVisible)
    {
        super(ev);
        BD bd = new BD();
    ...
    public ContenidoLlamada(int id)
    {
        super(id);
        BD bd = new BD();
    ...
    @Override
    public String getTipo() { return "llamada"; }

    @Override
    public VistaContenido getVista(boolean modoEdicion) {
        return new VistaContenidoLlamada(this, modoEdicion);
    }
