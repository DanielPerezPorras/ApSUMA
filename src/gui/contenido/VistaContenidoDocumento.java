...
public class VistaContenidoDocumento extends VistaContenido
{

    public VistaContenidoDocumento(Contenido cont, boolean modoEdicion)
    {
        super(cont, modoEdicion);
        ContenidoDocumento contenidoEnlace = (ContenidoDocumento)cont;
        ...
        resultado.setForeground(new Color(204, 0, 0)); //(0, 153, 51)
