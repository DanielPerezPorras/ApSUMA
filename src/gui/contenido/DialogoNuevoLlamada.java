...
public class DialogoNuevoLlamada extends JDialog {
    ...
    public DialogoNuevoLlamada(JFrame propietario) {
        super(propietario, "Nueva llamada grupal", true);
        crearGUI();
        asignarControlador(new ControladorDialogoNuevoLlamada(this));
    }
    ...
    private void crearGUI() {
        ...
        JLabel lblEnlace = new JLabel("URL de la llamada grupal: ");
        ...
        lblHyperlink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e)
            {
                ...
                lblHyperlink.setText("<html><a href=''>¡Créela aquí!</a></html>");
            }
    ...
    private void asignarControlador(ControladorDialogoNuevoLlamada ctr) {
